...
function CustomTooltip({ active, payload, label }: CustomTooltipProps) {
  ...
  return (
    <div className="bg-[#1A1D24] border border-[#243F6A] p-8 rounded-xl shadow-2xl backdrop-blur-md">
      <p className="text-[#94A3B8] text-[10px] font-black uppercase tracking-widest mb-7">{label}</p>
      {payload.map((entry, index: number) => (
        <div key={index} className="flex items-center gap-7 mb-6 last:mb-0">
