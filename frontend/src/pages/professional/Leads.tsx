...
export default function ProfessionalLeads() {
  ...
  return (
    <div className="w-full space-y-3">
      ...
      <div className="mb-2 flex gap-2 items-center" style={{ marginTop: '1.25rem' }}>
      ...
      {/* Header */}
      <div className="flex items-center justify-between">
        <h1 className="text-lg font-bold text-white flex items-center gap-2" style={{ marginTop: '1.25rem' }}>
      ...
      {/* Lead Cards Grid */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 w-full max-w-xl" style={{ marginTop: '1rem' }}>
        {leadsLoading ? (
