...
export default function ProfessionalDashboard() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-gradient-to-r from-emerald-500/10 to-transparent border border-emerald-500/20 rounded-xl px-5 py-4 flex items-center gap-4" style={{ marginTop: '1.5rem' }}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full" style={{ marginTop: '1.25rem' }}>
