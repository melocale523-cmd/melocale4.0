        ...
        <section id="planos" className="py-24 bg-[#0A0B0D] border-t border-slate-800/50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-4 gap-6 text-left max-w-6xl mx-auto mb-16">
              ...
              {/* GRATUITO */}
              <div className="bg-[#14161B] rounded-2xl border border-slate-800 p-8 flex flex-col">
                <div className="mb-6">
                  <h3 className="text-slate-400 font-bold text-sm uppercase tracking-widest mb-2">Gratuito</h3>
                  <div className="text-4xl font-extrabold text-white mb-1">R$ 0<span className="text-sm font-normal text-slate-500">/mês</span></div>
                  <p className="text-slate-500 text-xs">Para conhecer a plataforma</p>
                </div>
                ...
                <ul className="space-y-3 flex-1">
                  <li className="flex items-start gap-2 text-slate-400 text-sm"><CheckIcon className="text-slate-500 shrink-0 mt-0.5" size={16}/> Cadastro na plataforma</li>
                  <li className="flex items-start gap-2 text-slate-400 text-sm"><CheckIcon className="text-slate-500 shrink-0 mt-0.5" size={16}/> Ver leads disponíveis</li>
                  <li className="flex items-start gap-2 text-slate-400 text-sm"><CheckIcon className="text-emerald-500 shrink-0 mt-0.5" size={16}/> 10 moedas de boas-vindas</li>
                  <li className="flex items-start gap-2 text-slate-500 text-sm line-through"><XIcon className="text-slate-700 shrink-0 mt-0.5" size={16}/> Desconto em moedas</li>
                  <li className="flex items-start gap-2 text-slate-500 text-sm line-through"><XIcon className="text-slate-700 shrink-0 mt-0.5" size={16}/> Badge verificado</li>
                </ul>
              </div>

              {/* STARTER */}
              <div className="bg-[#14161B] rounded-2xl border border-blue-500/30 p-8 flex flex-col relative">
                <div className="mb-6">
                  ...
                  <div className="text-4xl font-extrabold text-white mb-1">R$ 37<span className="text-sm font-normal text-slate-500">/mês</span></div>
              ...
              {/* PRO — DESTAQUE */}
              <div className="bg-gradient-to-b from-[#1c1d28] to-[#14161B] rounded-2xl border-2 border-emerald-500 p-8 flex flex-col relative transform scale-105 z-10 shadow-[0_0_50px_-10px_rgba(16,185,129,0.4)]">
                ...
                <div className="mb-6">
                  ...
                  <div className="text-4xl font-extrabold text-white mb-1">R$ 67<span className="text-sm font-normal text-slate-500">/mês</span></div>
              ...
              {/* ELITE */}
              <div className="bg-[#14161B] rounded-2xl border border-yellow-500/30 p-8 flex flex-col relative">
                <div className="mb-6">
                  ...
                  <div className="text-4xl font-extrabold text-white mb-1">R$ 127<span className="text-sm font-normal text-slate-500">/mês</span></div>
            ...
            {/* Ancoragem de ROI */}
            <div className="max-w-3xl mx-auto bg-[#14161B] border border-white/5 rounded-2xl p-8 text-center">
              <p className="text-slate-400 text-sm mb-2">💡 Pense assim:</p>
              ...
              <p className="text-slate-500 text-sm">E com 40% de desconto em moedas, você acessa muito mais clientes pelo mesmo preço.</p>
            </div>
