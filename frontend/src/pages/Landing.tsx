      ...
      <main>
        ...
        <section id="planos" className="py-28" style={{ background: '#182035', borderTop: '2px solid #f59e0b', display: isCliente ? 'none' : 'block' }}>
          <div className="container-app">
            ...
            <div className="max-w-6xl mx-auto mb-10 grid grid-cols-1 sm:grid-cols-3 gap-4 px-4" style={{ marginBottom: '1.5rem', marginLeft: 'auto', marginRight: 'auto', maxWidth: '72rem', transform: isProfissional ? 'translateX(10rem)' : 'none' }}>
            ...
            <div className="max-w-6xl mx-auto bg-[#1e2d45] border border-[#1C3050] rounded-2xl p-6 text-center" style={{ marginBottom: '1rem', marginLeft: 'auto', marginRight: 'auto', transform: isProfissional ? 'translateX(10rem)' : 'none' }}>
