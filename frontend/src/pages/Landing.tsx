      ...
      <main>
        ...
        <section id="planos" className="py-28" style={{ background: '#182035', borderTop: '2px solid #f59e0b', display: isCliente ? 'none' : 'block' }}>
          <div className="container-app">
            ...
            <div className="max-w-6xl mx-auto mb-10 grid grid-cols-1 sm:grid-cols-3 gap-4" style={{ marginBottom: '1.5rem', marginLeft: 'auto', marginRight: 'auto', maxWidth: '72rem', transform: isProfissional ? 'translateX(8rem)' : 'none' }}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 text-left max-w-6xl mx-auto mb-12 px-4" style={{ marginBottom: '2rem', transform: isProfissional ? 'translateX(8rem)' : 'none' }}>
              {/* GRATUITO */}
