      ...
      <main>
        ...
        <section id="planos" className="py-28" style={{ background: '#182035', borderTop: '2px solid #f59e0b', display: isCliente ? 'none' : 'block' }}>
          <div className="container-app">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 max-w-6xl mx-auto mb-10 px-4" style={{ marginBottom: '1.5rem', transform: isProfissional ? 'translateX(10rem)' : 'none' }}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 text-left max-w-6xl mx-auto mb-12 px-4" style={{ marginBottom: '2rem', transform: isProfissional ? 'translateX(10rem)' : 'none' }}>
              {/* GRATUITO */}
            ...
            <div className="max-w-6xl mx-auto px-4" style={{ marginBottom: '1rem', transform: isProfissional ? 'translateX(10rem)' : 'none', overflowX: 'auto' }}>
              <div style={{ width: 'fit-content', background: '#1e2d45', border: '1px solid #1C3050', borderRadius: 16, padding: '1rem 1.5rem', textAlign: 'center', boxSizing: 'border-box' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 5, marginBottom: 5 }}>
                  <span style={{ fontSize: 14 }}>💡</span>
                  <span style={{ fontSize: 11, color: '#94A3B8', fontWeight: 600, whiteSpace: 'nowrap' }}>Pense assim:</span>
                </div>
                <p style={{ fontSize: 19, fontWeight: 700, color: '#f0f6ff', margin: '0 0 5px', lineHeight: 1.3, whiteSpace: 'nowrap' }}>
                  1 cliente de <span style={{ color: '#10b981' }}>R$ 500</span> já paga o plano PRO por <span style={{ color: '#10b981' }}>7 meses</span>
                </p>
                <p style={{ fontSize: 12, color: '#94A3B8', margin: '0 0 14px', whiteSpace: 'nowrap' }}>
                ...
                <div style={{ display: 'flex', flexWrap: 'nowrap', justifyContent: 'center', gap: 6 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 5, background: 'rgba(16,185,129,.12)', border: '1px solid rgba(16,185,129,.3)', borderRadius: 9, padding: '6px 12px', whiteSpace: 'nowrap' }}>
                    <span style={{ fontSize: 13 }}>🧮</span>
                    <div style={{ textAlign: 'left' }}>
                      <div style={{ fontSize: 9, color: '#94A3B8' }}>matemática real</div>
                      <div style={{ fontSize: 11, fontWeight: 700, color: '#f0f6ff' }}>R$67 × 7 ≈ R$469</div>
                    </div>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 5, background: 'rgba(16,185,129,.12)', border: '1px solid rgba(16,185,129,.3)', borderRadius: 9, padding: '6px 12px', whiteSpace: 'nowrap' }}>
                    <span style={{ fontSize: 13 }}>🎁</span>
                    <div style={{ textAlign: 'left' }}>
                      <div style={{ fontSize: 9, color: '#94A3B8' }}>desconto em moedas</div>
                      <div style={{ fontSize: 11, fontWeight: 700, color: '#f0f6ff' }}>40% off</div>
                    </div>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 5, background: 'rgba(16,185,129,.12)', border: '1px solid rgba(16,185,129,.3)', borderRadius: 9, padding: '6px 12px', whiteSpace: 'nowrap' }}>
                    <span style={{ fontSize: 13 }}>⚡</span>
                    <div style={{ textAlign: 'left' }}>
                      <div style={{ fontSize: 9, color: '#94A3B8' }}>retorno rápido</div>
                      <div style={{ fontSize: 11, fontWeight: 700, color: '#f0f6ff' }}>2 leads cobrem o mês</div>
                    </div>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 5, background: 'rgba(16,185,129,.12)', border: '1px solid rgba(16,185,129,.3)', borderRadius: 9, padding: '6px 12px', whiteSpace: 'nowrap' }}>
                    <span style={{ fontSize: 13 }}>📈</span>
                    <div style={{ textAlign: 'left' }}>
                      <div style={{ fontSize: 9, color: '#94A3B8' }}>ganho médio extra</div>
                      <div style={{ fontSize: 11, fontWeight: 700, color: '#f0f6ff' }}>+R$1.800/mês</div>
                    </div>
                  </div>
                </div>
              </div>
