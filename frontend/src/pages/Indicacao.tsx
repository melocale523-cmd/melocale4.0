  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        {hasDoubleBonus && (
          <div className="shrink-0 bg-yellow-400/15 border border-yellow-400/30 rounded-2xl px-4 py-3 text-center">
            ...
            {loadingCode ? (
              ...
              <>
                <div className="flex items-center gap-2 bg-[#0c1829] border border-white/8 rounded-xl px-4 py-3 mb-3">
                  ...
                  <button onClick={copyLink} className="flex items-center gap-1.5 bg-emerald-400/15 hover:bg-emerald-400/25 border border-emerald-400/30 text-emerald-400 text-xs font-semibold px-3 py-1.5 rounded-lg transition-colors shrink-0">
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="font-mono font-bold text-lg text-white tracking-widest bg-white/5 px-4 py-1 rounded-lg border border-white/8">
                    {referralData?.code ?? '—'}
                  </span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 bg-purple-500/15 hover:bg-purple-500/25 border border-purple-500/30 text-purple-300 text-sm py-2.5 rounded-xl transition-colors disabled:opacity-50"
                  >
                ...
                {showQr && referralData?.link && (
                  <div className="mt-4 flex flex-col items-center gap-2 bg-white p-5 rounded-2xl">
        ...
        <div className="space-y-5">
          ...
          {referralData && (
            <div className="grid grid-cols-3 gap-3">
              ...
              <div className="bg-emerald-400/8 border border-emerald-400/20 rounded-2xl p-4 text-center">
                ...
                <div className="text-xs text-slate-500 mt-1">{isPro ? 'moedas' : 'créditos'}</div>
              </div>
            </div>
          )}
            ...
            <div className="bg-white/5 border border-white/8 rounded-2xl p-5">
              <div className="flex items-center justify-between mb-3">
                ...
                {monthly.bonus_credited ? (
                  <span className="text-[10px] font-black text-emerald-400 bg-emerald-400/10 px-2 py-0.5 rounded-full">500 moedas ✓</span>
                ) : (
          ...
          <div>
            <h3 className="text-sm font-semibold text-white mb-3 flex items-center gap-2">
              ...
              {referrals.length > 0 && (
                <span className="bg-white/8 text-slate-400 text-xs px-2 py-0.5 rounded-full font-mono">{referrals.length}</span>
              )}
            </h3>
            {loadingList ? (
              <div className="space-y-2">
                  ...
                  return (
                    <div key={r.id} className="flex items-center gap-3 bg-white/4 border border-white/8 rounded-xl px-4 py-3">
                      ...
                      <div className="text-right shrink-0">
                        ...
                        {r.status === 'credited' && (
                          <div className="text-xs text-emerald-400 font-mono mt-1">+{r.reward_amount || baseReward}</div>
                        )}
                      </div>
                    </div>
                  )
