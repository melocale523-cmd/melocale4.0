            ...
            <div className="bg-white/3 border border-white/8 rounded-2xl p-10">
              ...
              <div className="space-y-7">
                {ranking.map((r) => {
                  ...
                  return (
                    <div key={r.referrer_id} className={`flex items-center gap-8 rounded-xl px-8 py-2.5 ${isMe ? 'bg-emerald-400/10 border border-emerald-400/20' : 'bg-white/4'}`}>
                  ...
                  return (
                    <div key={r.id} className="flex items-center gap-8 bg-white/4 border border-white/8 rounded-xl px-9 py-8">
                      ...
                      <div className="text-right shrink-0">
                        <div className={`text-xs font-semibold ${cfg.color} ${cfg.bg} px-7 py-0.5 rounded-full`}>{cfg.label}</div>
                        {r.status === 'credited' && (
