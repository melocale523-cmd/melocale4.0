...
export function ProfessionalProfileModal({ userId, name, avatar, onClose }: ProfessionalProfileModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[300] flex items-center justify-center p-9">
            ...
            <div className="pb-1">
              ...
              {prof && (
                <div className="flex flex-wrap gap-7 mt-6">
                  {prof.category && (
                    <span className="text-xs text-emerald-400 font-medium flex items-center gap-6">
                      <Briefcase size={12} /> {prof.category}
                    </span>
                  )}
                  {prof.city && (
                    <span className="text-xs text-[#94A3B8] flex items-center gap-6">
