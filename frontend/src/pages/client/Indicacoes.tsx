      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 380px', gap: '1.5rem', alignItems: 'start' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', minWidth: 0 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px' }}>
              {/* Card — Suas moedas */}
              <div style={{ background: '#0b2818', border: '1px solid #10b981', borderRadius: '1rem', padding: '1rem' }}>
                ...
                <div style={{ fontFamily: 'DM Mono, monospace', fontSize: '1.5rem', fontWeight: 700, color: '#10b981', lineHeight: 1 }}>
                  {coinsData?.balance ?? 0}
                </div>
              ...
              {/* Card — Missão do mês */}
              <div style={{ ...cardBase, borderTop: '3px solid #7c3aed', padding: '1rem' }}>
              ...
              <div style={{ ...cardBase, borderTop: '3px solid #f59e0b', padding: '1rem' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '10px' }}>
