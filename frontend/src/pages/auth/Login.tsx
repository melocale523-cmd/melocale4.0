            ...
            <>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                ...
                <button
                  ...
                  className="flex flex-col items-center gap-3 p-5 rounded-3xl border-2 border-blue-500/30 bg-blue-500/5 hover:bg-blue-500/10 hover:border-blue-500/60 transition-all text-center group"
                >
                  ...
                  <div className="w-full flex items-center justify-center gap-2 h-10 bg-white hover:bg-slate-100 text-[#0E1C32] rounded-xl font-black text-xs transition-all mt-1">
                ...
                <button
                  ...
                  className="flex flex-col items-center gap-3 p-5 rounded-3xl border-2 border-emerald-500/30 bg-emerald-500/5 hover:bg-emerald-500/10 hover:border-emerald-500/60 transition-all text-center group"
                >
                  <span className="text-3xl">🔧</span>
                  <div>
