    ...
    <div className="space-y-6 fade-in">
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-[#94A3B8] mt-1">Casos que exigem revisão humana, priorizados por risco</p>
        </div>
      ...
      <div className="bg-[#1C3454] border border-emerald-500/20 rounded-xl p-16 flex flex-col items-center justify-center text-center space-y-4">
         <div className="w-16 h-16 bg-emerald-500/10 rounded-full flex items-center justify-center">
            <ShieldCheck className="w-8 h-8 text-emerald-500" />
         </div>
         <div>
            <h2 className="text-xl font-bold text-white mb-2">Nenhuma disputa aberta</h2>
            <p className="text-[#94A3B8]">Todos os casos foram resolvidos ou não há pendências.</p>
         </div>
      </div>
    </div>
  );
