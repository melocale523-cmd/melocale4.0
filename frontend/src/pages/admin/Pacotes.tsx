             ...
             <div key={pacote.id} className="bg-[#1C3454] border border-slate-800 rounded-2xl p-11 flex flex-col relative overflow-hidden group">
               ...
               <div className="flex justify-between items-start mb-11 z-10 relative">
                  <div>
                    ...
                    <span className={`inline-block mt-7 px-2.5 py-6 text-[10px] font-bold uppercase tracking-widest rounded border ${pacote.is_active ? 'bg-emerald-500/10 text-emerald-500 border-emerald-500/20' : 'bg-red-500/10 text-red-400 border-red-500/20'}`}>
               ...
               <div className="flex items-center gap-8 mt-auto pt-6 border-t border-[#1C3050] z-10 relative">
                  ...
                  <button
                    ...
                    className={`flex items-center justify-center gap-6 py-2.5 px-8 rounded-lg transition-colors text-sm font-medium disabled:opacity-50 ${pacote.is_active ? 'bg-red-500/10 hover:bg-red-500/20 text-red-400' : 'bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-400'}`}
