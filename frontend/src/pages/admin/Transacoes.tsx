    ...
    <div className="space-y-6 fade-in">
      ...
      <div className="flex gap-4 mb-6">
        <div className="flex-1 relative">
           ...
           <input type="text" placeholder="Buscar profissional..." className="w-full bg-[#1C3454] border border-slate-800 rounded-lg pl-10 pr-4 py-3 text-slate-200 placeholder:text-slate-600 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all"/>
        </div>
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
           ...
           <div className="bg-[#1C3454] border border-slate-700 rounded-xl p-6 w-full max-w-md relative z-50">
              ...
              <div className="space-y-4 text-sm">
                  <div className="flex justify-between"><span className="text-[#4A6580]">Usuário:</span><span className="text-white">{selectedTx.user}</span></div>
                  <div className="flex justify-between"><span className="text-[#4A6580]">Método:</span><span className="text-white">{selectedTx.metodo}</span></div>
                  <div className="flex justify-between"><span className="text-[#4A6580]">Data Real:</span><span className="text-white">{selectedTx.timestamp}</span></div>
                  <div className="flex justify-between"><span className="text-[#4A6580]">ID:</span><span className="text-white font-mono break-all">{selectedTx.id}</span></div>
              </div>
           </div>
        </div>
      )}
