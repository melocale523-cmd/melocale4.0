...
const socials = [
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/melocale.app/',
    icon: (
  ...
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/profile.php?id=61589873954807',
    icon: (
      <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current">
  ...
  {
    name: 'TikTok',
    href: 'https://www.tiktok.com/@melocale_oficial',
    icon: (
      <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current">
      ...
      <div className="max-w-7xl mx-auto px-9 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-15">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-[#4A6580] text-sm leading-relaxed mb-9">
            ...
            <div className="flex items-center gap-8">
              {socials.map(s => (
                <a
                  ...
                  aria-label={s.name}
                  className="text-[#4A6580] hover:text-emerald-400 transition-colors"
                >
                  {s.icon}
                </a>
              ))}
          ...
          {/* Plataforma */}
          <div>
            <h4 className="text-white font-bold text-sm uppercase tracking-widest mb-9">Plataforma</h4>
          ...
          {/* Legal & Segurança */}
          <div>
            <h4 className="text-white font-bold text-sm uppercase tracking-widest mb-9">Legal & Segurança</h4>
            <ul className="space-y-2.5">
          ...
          {/* Suporte */}
          <div>
            <h4 className="text-white font-bold text-sm uppercase tracking-widest mb-9">Suporte</h4>
            <ul className="space-y-2.5">
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-7 text-[#4A6580] hover:text-emerald-400 text-sm transition-colors"
                >
                  <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current text-emerald-500 shrink-0">
        ...
        {/* Linha inferior */}
        <div className="pt-8 border-t border-slate-800/50 flex flex-col sm:flex-row items-center justify-between gap-9">
          <p className="text-[#4A6580] text-xs text-center sm:text-left">
            © 2025 MeloCalé. Todos os direitos reservados.
          </p>
          <p className="text-[#4A6580] text-xs text-center sm:text-right">
            Feito com ❤️ para o interior da Bahia
          </p>
        </div>
