      ...
      >
        ...
        <div className="absolute top-4 left-4 flex flex-col gap-2">
           ...
           <div className="flex gap-2">
            ...
            <span className="bg-black/60 backdrop-blur-sm text-white text-[10px] uppercase font-bold px-3 py-1 rounded-full border border-[#243F6A]">
      ...
      <div className="p-6 flex flex-col flex-1">
        <div className="flex items-center justify-between mb-2">
          <div className="relative group/rating flex items-center gap-1 text-emerald-400 cursor-help">
            ...
            <div className="absolute left-0 -top-10 bg-[#1C3454] border border-[#243F6A] px-3 py-1.5 rounded-lg text-xs font-medium text-slate-300 opacity-0 group-hover/rating:opacity-100 transition-opacity whitespace-nowrap pointer-events-none z-10 shadow-lg">
              Avaliação baseada em {professional.reviewsCount} reviews
            </div>
          </div>
          <div className="flex items-center gap-1 text-[#4A6580]">
            <MapPin size={12} />
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          {professional.specialties.map(s => (
            <span key={s} className="text-[9px] uppercase font-bold px-2 py-0.5 bg-white/5 text-[#94A3B8] rounded border border-[#1C3050] whitespace-normal leading-tight text-center max-w-full">
              {s}
            </span>
          ))}
        </div>

        <div className="flex flex-col gap-3 border-t border-[#1C3050] pt-4">
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-6">
            ...
            >
              <button 
                ...
                className="absolute top-4 right-4 z-20 p-2 bg-black/40 backdrop-blur-md rounded-full text-white hover:bg-red-500 hover:text-white transition-all shadow-sm border border-[#243F6A]"
              >
                <X size={20} />
              </button>
              ...
              <div className="relative h-64 md:h-72 shrink-0">
                ...
                <div className="absolute bottom-6 left-6 right-6 flex flex-col items-start gap-2">
                   <div className="flex gap-2 mb-1">
                     ...
                     <span className="bg-white/10 backdrop-blur-sm text-white text-[10px] uppercase font-bold px-3 py-1 rounded-full border border-[#243F6A]">
                        {professional.category}
                     </span>
                   </div>
              ...
              <div className="p-6 overflow-y-auto custom-scrollbar flex-1">
                <div className="flex items-center gap-6 mb-6 pb-6 border-b border-[#1C3050]">
                  <div className="flex flex-col">
                    <span className="text-[10px] uppercase font-bold text-[#4A6580] mb-1">Avaliação</span>
                  ...
                  <div className="flex flex-col">
                    <span className="text-[10px] uppercase font-bold text-[#4A6580] mb-1">Localização</span>
                ...
                <h3 className="text-xs font-bold text-[#4A6580] uppercase tracking-widest mb-3">Sobre o Profissional</h3>
                <p className="text-slate-300 text-sm leading-relaxed mb-8">
                  {professional.description}
                </p>

                <h3 className="text-xs font-bold text-[#4A6580] uppercase tracking-widest mb-3">Especialidades</h3>
                <div className="flex flex-wrap gap-2 mb-2">
                  {professional.specialties.map(s => (
                    <span key={s} className="text-xs uppercase font-bold px-3 py-1.5 bg-white/5 text-slate-300 rounded-lg border border-[#243F6A]">
                      {s}
                    </span>
                  ))}
                </div>
              ...
              <div className="p-6 border-t border-[#243F6A] bg-[#0E1C32] flex items-center justify-between shrink-0">
                <div className="flex flex-col">
                  <span className="text-[10px] text-[#4A6580] font-bold uppercase tracking-widest">A partir de</span>
