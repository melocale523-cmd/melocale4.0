...
export default function Hero() {
  return (
    <section id="hero" className="relative min-h-[90vh] flex items-center pt-20 overflow-hidden">
      ...
      <div className="container mx-auto px-11 relative z-10 text-white">
        <div className="max-w-3xl">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            className="inline-flex items-center gap-7 px-8 py-6 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs font-bold uppercase tracking-widest mb-11 w-fit"
          >
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl font-bold leading-[1.1] mb-11 tracking-tight"
          >
            O profissional <br/>
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-[#94A3B8] mb-15 max-w-xl font-light leading-relaxed"
          >
          ...
          <motion.div
            ...
            className="bg-[#1C3454]/80 backdrop-blur-xl p-7 md:p-3 rounded-2xl md:rounded-3xl border border-[#243F6A] shadow-2xl flex flex-col md:flex-row items-center gap-7 max-w-4xl"
          >
            <div className="flex-1 w-full grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-white/5">
              <div className="flex items-center gap-8 px-9 py-8 cursor-pointer group">
            ...
            <button className="w-full md:w-auto bg-emerald-500 hover:bg-emerald-400 text-black px-8 py-9 rounded-xl md:rounded-2xl font-bold flex items-center justify-center gap-7 transition-all shadow-lg shadow-emerald-500/20">
              <Search size={20} />
          ...
          <div className="mt-12 grid grid-cols-3 gap-8 pt-8 border-t border-[#1C3050] max-w-xl">
            <div>
              ...
              <div className="text-[10px] text-[#4A6580] uppercase tracking-widest mt-6">Serviços Realizados</div>
            </div>
            <div>
              <div className="text-2xl font-bold">156</div>
              <div className="text-[10px] text-[#4A6580] uppercase tracking-widest mt-6">Categorias</div>
            </div>
            <div>
              <div className="text-2xl font-bold">12.5k</div>
              <div className="text-[10px] text-[#4A6580] uppercase tracking-widest mt-6">Profissionais</div>
            </div>
          </div>
        </div>
      </div>

      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 hidden md:flex flex-col items-center gap-7 text-white/50">
