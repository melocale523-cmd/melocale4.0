  ...
  return (
    <section className="py-8 md:py-20 bg-[#0E1C32] border-t border-slate-800/50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4 md:gap-6 mb-8 md:mb-12">
          {categories.map(cat => (
            <Link
              key={cat.slug}
              to={`/login?mode=signup&servico=${cat.slug}`}
              className="group flex flex-col items-center gap-3 bg-[#1C3454] hover:bg-emerald-500/10 border border-slate-800 hover:border-emerald-500/40 rounded-2xl p-4 md:p-6 transition-all duration-200"
            >
        ...
        <div className="text-center">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 h-12 md:h-14 bg-emerald-500 hover:bg-emerald-400 text-black font-black px-6 md:px-8 rounded-xl text-sm shadow-lg shadow-emerald-500/20 transition-all uppercase tracking-wide"
          >
