  ...
  return (
    <>
      <nav
        ...
        className={cn(
          'fixed left-0 right-0 z-50 transition-all duration-300 px-9 md:px-6 py-8 md:py-4 border-b',
            ...
            {!isAuthenticated ? (
              <>
                ...
                <Link
                  ...
                  className={cn(
                    'px-8 py-1.5 md:px-5 md:py-2.5 rounded-xl text-xs md:text-sm font-black transition-all whitespace-nowrap',
                    pastHero
