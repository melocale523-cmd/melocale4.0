...
import { Home, ClipboardList, MessageSquare, UserCircle, LogOut, ArrowLeft, Menu, X, CalendarDays } from 'lucide-react';
...
export default function ClientLayout() {
  ...
  const navItems = [
    ...
    { name: 'Agenda', path: '/cliente/agenda', icon: CalendarDays },
