          ...
          {ADMIN_NAVIGATION.map((item) => {
            ...
            return (
              <Link
                ...
                to={item.href}
                className={cn(
                  "flex items-center gap-8 px-9 py-8 rounded-xl text-sm font-medium transition-all duration-200",
                  isActive
                 ...
                 {ADMIN_NAVIGATION.map((item) => {
                    ...
                    return (
                      <Link
                        ...
                        className={cn(
                          "flex items-center gap-8 px-9 py-8 rounded-xl text-sm font-medium",
