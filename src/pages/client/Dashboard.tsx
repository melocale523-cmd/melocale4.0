...
import { AlertCircle, ArrowRight, Plus, Hammer, Shield, Clock, TrendingUp, Inbox, MessageCircle, FileText, X, Loader2 } from 'lucide-react';
...
export default function ClientDashboard() {
  ...
  const userName = user?.name ? user.name.split(' ').map(n => n.charAt(0).toUpperCase() + n.slice(1)).join(' ') : 'Usuário';
